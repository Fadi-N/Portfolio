...
const IphoneWebsite = () => {
    return (
        <>
            ...
            Leveraging the robust capabilities of Three.js and the React Three Fiber library, the site offers a dynamic real-time 3D experience that allows users to explore the details of the iPhone model from every angle.
